...
\begin{document}
	...
	\section*{Objective}
	\indent{Design, implement, and deliver excellent solutions to real-world problems.}
	...
	\begin{description}
		...
		Design, implementation, deployment and maintenance of CAD software applications and CNC control software (C\#, WPF, C++, Forth). Design and maintenance of internal network (Linux and Windows Server administration). Primary maintainer of company website; primary coder of 2009 website re-design (XHTL, CSS, PHP).
